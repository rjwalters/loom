...
echo ""
info "Broken machine-level PATH shims (issue #5738):"
echo "  - ~/.local/bin/loom-* symlinks left dangling by the retired loom-tools"
echo "    venv. Only provably-dead links are unlinked (symlink + dangling +"
echo "    target inside a loom-tools/.venv); live shims and any script you"
echo "    wrote yourself are never touched."
echo ""
info "Modifications:"
