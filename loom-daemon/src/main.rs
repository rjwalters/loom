...
enum Commands {
    ...
    SweepOutcomes {
        ...
        #[command(subcommand)]
        command: Option<SweepOutcomesAction>,
    },
}

/// Sub-actions for `loom-daemon sweep-outcomes` (Issue #8057).
#[derive(Subcommand)]
enum SweepOutcomesAction {
    ...
    Summary {
        ...
        /// Grouping dimension: arm, model, repo, host, day.
...
use cli::misc_cmds::{
    handle_sweep_outcomes_command, handle_sweep_outcomes_summary_command,
    handle_update_gitignore_command, handle_validate_command, SweepOutcomesSummaryArgs,
};
    ...
    match command {
        ...
        Commands::SweepOutcomes {
            ...
            Some(SweepOutcomesAction::Summary {
                ...
                no_merge_join,
                json,
            }) => handle_sweep_outcomes_summary_command(&SweepOutcomesSummaryArgs {
                workspace: &workspace,
...
mod cli_parse_tests {
    ...
    fn summary_sub_verb_parses_its_own_flags() {
        match parse(&[
            ...
            Commands::SweepOutcomes { command, .. } => match command {
                Some(SweepOutcomesAction::Summary {
                    workspace,
                    since,
                    all_workspaces,
