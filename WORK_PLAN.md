...
- **#5874**: VERSION does not bump on defaults/ prompt changes, so every currency check reports a fleet as current while its agents run different instructions *(curated)*
