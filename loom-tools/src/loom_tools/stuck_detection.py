...
class StuckDetectionRunner:
    ...
    def _trigger_intervention(self, detection: StuckDetection) -> None:
        ...
        summary = self._format_intervention_summary(detection, timestamp)
    ...
    def _format_intervention_summary(
        self, detection: StuckDetection, timestamp: str
    ) -> str:
        ...
        lines.extend(
            [
                "",
                f"Intervention file: {self.loom_dir}/interventions/{detection.agent_id}-*.json",
            ]
        )
