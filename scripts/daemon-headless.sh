...
echo "  - mcp__loom-terminals__list_terminals"
echo "  - mcp__loom-terminals__get_terminal_output"
echo "  - mcp__loom-ui__read_state_file"
echo "  - mcp__loom-logs__tail_daemon_log"
echo ""
