...
#   N is appended to its own argv (by SweepRegistry::dispatch → spawn_child).
#   The daemon and multi-account pool are therefore reachable BY CONSTRUCTION —
#   but this child must NOT re-dispatch.
