...
non-closing reference, and the requirement to carry the **same** reference in the PR body
(and, consistently, in the commit messages) — is the canonical guidance in
