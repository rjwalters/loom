...
- [4b. The gateway collector: multi-sink fanout + runtime session tails (issue #8664)](#4b-the-gateway-collector-multi-sink-fanout--runtime-session-tails-issue-8664)
